    ...
    public void cadastrarPaciente(Paciente pac) throws SQLException {
        ...
        try {
            ...
            // String que receberá instrução SQL
             String sql = "insert into PACIENTE(NOME, CPF, RG, ENDERECO, TELEFONE, EMAIL,"
						  + " DATA_NASC, ID_CONVENIO_FK) values(?,?,?,?,?,?,?,?)";
            ...
            pst.setString(1, pac.getNome());
				...
				pst.setString(5, pac.getTelefone());
				pst.setString(6, pac.getEmail());            
            pst.setString(7, sdf.format(pac.getDataNascimento()));         
